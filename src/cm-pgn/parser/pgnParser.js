...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c50 = function(fig, str, col, row, pr, ch) { var hm = { location: location() }; hm.fig = (fig ? fig : null); hm.strike = (str ? str : null); hm.col = col; hm.row = row; hm.check = (ch ? ch : null); hm.notation = (fig ? fig : "") + (str ? str : "") + col  + row + (pr ? pr : "") + (ch ? ch : ""); hm.promotion = pr; return hm; },
      peg$c51 = "O-O-O",
      peg$c52 = peg$literalExpectation("O-O-O", false),
      peg$c53 = function(ch) { var hm = { location: location() }; hm.notation = 'O-O-O'+ (ch ? ch : ""); hm.check = (ch ? ch : null); return  hm; },
      peg$c54 = "O-O",
      peg$c55 = peg$literalExpectation("O-O", false),
      peg$c56 = function(ch) { var hm = { location: location() }; hm.notation = 'O-O'+ (ch ? ch : ""); hm.check = (ch ? ch : null); return  hm; },
      peg$c57 = "+-",
