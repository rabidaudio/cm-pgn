...
`, undefined, true, 165, 7)
        ...
        assert.equal(history.moves[0].location.end.offset, 165 + 8)
        assert.equal(history.moves[0].location.end.line, 7 + 1)
        assert.equal(history.moves[0].location.end.column, 9)

        assert.equal(history.moves[1].location.start.offset, 165 + 9)
        assert.equal(history.moves[1].location.start.line, 7 + 1)
        assert.equal(history.moves[1].location.start.column, 10)
        assert.equal(history.moves[1].location.end.offset, 165 + 13)
        assert.equal(history.moves[1].location.end.line, 7 + 1)
        assert.equal(history.moves[1].location.end.column, 14)

        assert.equal(history.moves[1].variations[0][0].location.start.offset, 165 + 15)
        assert.equal(history.moves[1].variations[0][0].location.start.line, 7 + 1)
        assert.equal(history.moves[1].variations[0][0].location.start.column, 16)
        assert.equal(history.moves[1].variations[0][0].location.end.offset, 165 + 17)
        assert.equal(history.moves[1].variations[0][0].location.end.line, 7 + 1)
        assert.equal(history.moves[1].variations[0][0].location.end.column, 18)


        assert.equal(history.moves[2].location.start.offset, 165 + 22)
        assert.equal(history.moves[2].location.start.line, 7 + 2)
        assert.equal(history.moves[2].location.start.column, 4)
        assert.equal(history.moves[2].location.end.offset, 165 + 25)
        assert.equal(history.moves[2].location.end.line, 7 + 2)
        assert.equal(history.moves[2].location.end.column, 7)

        assert.equal(history.moves[3].location.start.offset, 165 + 42)
        assert.equal(history.moves[3].location.start.line, 7 + 2)
        assert.equal(history.moves[3].location.start.column, 24)
        assert.equal(history.moves[3].location.end.offset, 165 + 45)
        assert.equal(history.moves[3].location.end.line, 7 + 2)
